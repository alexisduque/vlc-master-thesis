...
The first part of the circuit is the Trans-Impedance Amplifier, presented in \ref{fig:tia}. TIA is a standard electronic pattern, used to convert the current to a tension.

MCP6292 AOP is alimented with the 3.3V tension source from the MCU.
...
\section{Receiver DAC and Buffer}
...
According to \ref{tab:conclusion-adc}, we chose to use the STM32L0 miro-controller based on an ARM Cortex  M0+ processor. 
\subsection{Decoding}
