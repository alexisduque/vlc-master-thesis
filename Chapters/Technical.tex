...
\begin{figure}[htbp]
  \centering
    \scalebox{0.4}{\includegraphics[width=\textwidth]{Pictures/manchester.png}}
    \rule{35em}{0.5pt}
...
The kit contains three dev boards and a bunch of cables. The dev boards are an application processor (AP) board, a Generic Endpoint Dev Board and an Endo Switch Dev Board.
